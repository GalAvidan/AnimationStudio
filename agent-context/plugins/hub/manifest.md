...
current_work:
  source_path: Vault/hub/studios/AnimationStudio/projects
  read_mode: directory-index
  empty_note: "No active projects. All prior work is archived at Vault/hub/studios/AnimationStudio/archive/projects/."
...
recent_activity:
  source_path: Vault/hub/studios/AnimationStudio/projects
  read_mode: directory-index
  empty_note: "No recent activity. Check Vault/hub/studios/AnimationStudio/archive/projects/ for archived work."
...
security:
  allow_paths:
    ...
    - Vault/hub/studios/AnimationStudio/projects/
  ...
  deny_paths:
    ...
    - .git\
    - Vault/hub/studios/AnimationStudio/archive/projects/character-pilot/manifest/

confidence_rules:
  status_confidence: medium

notes: >
  current_work and recent_activity read from Vault/hub/studios/AnimationStudio/projects/ (the live content root).
  When that folder is empty, Hub should report "no active projects" and point to the archive.
  Archive path: Vault/hub/studios/AnimationStudio/archive/projects/.

...
10. **Preview:** run `pnpm --filter ./projects/<name> dev` or use `preview` task.
11. **Render:** run `pnpm --filter ./projects/<name> render -- --props=./props/<variant>.json` or use `render` task.

...
2. For a commission, validate the brief header and required v3 sections before
...
5. For commissioned work, add a traceability row for every production beat:
   content beat IDs, approved claim IDs, and the acceptance checks it covers.
6. Run content-contract traceability. Do not browse for subject-matter facts or
   introduce a factual assertion outside `## Approved claims`.

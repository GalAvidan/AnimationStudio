# Script: <Project Title> — <Variant> Audience
...
<!-- Write in plain language. One idea per paragraph.
     Use visual beat markers in brackets like [VISUAL: ...] to indicate where visuals should do the work.
     Use sync markers like [SYNC: sync-point-id] where a visual event must land on a word.
